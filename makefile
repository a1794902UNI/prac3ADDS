...
run: main.o Computer.o Avalanche.o  RandomComputer.o Human.o Referee.o Player.o Bureaucrat.o Toolbox.o FistfullODollars.o Crescendo.o PaperDoll.o
	g++ -std=c++11 -o run -O2 -Wall main.cpp Computer.cpp Avalanche.cpp RandomComputer.cpp Crescendo.cpp Human.cpp FistfullODollars.cpp PaperDoll.cpp Referee.cpp Player.cpp Bureaucrat.cpp Toolbox.cpp
